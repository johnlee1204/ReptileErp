...
Ext.define('Log.view.AccessLogs', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.accesslogs',

    requires: [
        'Log.view.AccessLogsViewModel',
        'Ext.form.Panel',
        'Ext.button.Button',
        'Ext.form.field.Date',
        'Ext.form.field.Time',
    ...
    onAccessLogsRender: function(component, eOpts) {
        this.loadLogs();
    },
    ...
    loadLogs: function() {
        ...
        var logGridStore = this.getViewModel().getStore('LogGridStore');
