...
class ItemMaster extends AgileBaseController
{
	function searchParts() {
		...
		$this->outputSuccessData(ItemMasterModel::searchParts($input['partName']));
	}
	...
	function readPartsCombo() {
		...
		$this->outputSuccessData(ItemMasterModel::readPartsCombo($input['partName']));
	}
	...
	function readPart() {
		...
		$this->outputSuccessData(ItemMasterModel::readPart($input['partId']));
	...
	function createPart() {
		...
		if(ItemMasterModel::readPartByName($inputs['partName']) !== NULL) {
	...
	function deletePart() {
		...
		ItemMasterModel::deletePart($input['partId']);
		$this->outputSuccess();
	}
	...
	function readPartBom() {
		...
		$this->outputSuccessData(ItemMasterModel::readPartBom($input['partId']));
	}
	...
	function readPartBomRecord() {
		...
		$this->outputSuccessData(ItemMasterModel::readPartBomRecord($input['bomId']));
	}
	...
	function createBomRecord() {
		...
		ItemMasterModel::createBomRecord($inputs);

		$newBomId = ItemMasterModel::readLastBomRecordMade();
	...
	function updateBomRecord() {
		...
		ItemMasterModel::updateBomRecord($inputs);
	...
	function deleteBomRecord() {
		...
		ItemMasterModel::deleteBomRecord($input['bomId']);
		$this->outputSuccess();
	}
	...
	function readRoutings() {
		...
		$this->outputSuccessData(ItemMasterModel::readRoutings($input['partId']));
	...
	function readRouting() {
		...
		$this->outputSuccessData(ItemMasterModel::readRouting($input['routingId']));
	...
	function createRouting() {
		...
		ItemMasterModel::createRouting($inputs);

		$newRoutingId = ItemMasterModel::readLastRoutingMade();
	...
	function updateRouting() {
		...
		ItemMasterModel::updateRouting($inputs);
	...
	function deleteRouting() {
		...
		ItemMasterModel::deleteRouting($input['routingId']);
		$this->outputSuccess();
	}
	...
	function createManufacturingLayout() {
		...
		$part = ItemMasterModel::readPart($input['partId']);
		$routing = ItemMasterModel::readRoutings($input['partId']);
...
.tree li a:hover+ul ul::before{
	...
	function createManufacturingLayoutRecursive($partId, &$childrenArray, &$workcenters, &$energy) {
		...
		foreach($children as $child) {
			$routing = ItemMasterModel::readRoutings($child['partId']);
