...
Ext.define('Satisfactory.view.PartMaster', {
	...
	requires: [
		'Satisfactory.view.PartMasterViewModel',
		'Satisfactory.view.Part',
		'Satisfactory.view.PartBom',
		'Satisfactory.view.PartRouting',
		'Ext.toolbar.Toolbar',
		'Ext.form.field.Text',
		'Ext.tab.Panel',
		'Ext.tab.Tab'
	...
	onButtonClick: function(button, e, eOpts) {
		window.open("/Satisfactory/createManufacturingLayout?partId=" + this.partId);
	},
	...
	searchParts: function() {
		if(!this.partSearchWindow) {
			this.partSearchWindow = Ext.create("Satisfactory.view.PartSearchWindow", {
				listeners: {
