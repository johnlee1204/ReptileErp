...
Ext.define('Satisfactory.view.PartBomForm', {
	...
	requires: [
		'Satisfactory.view.PartBomFormViewModel',
		'Ext.toolbar.Toolbar',
	...
	readBomRecord: function(bomId) {
		AERP.Ajax.request({
			url:'/Satisfactory/readPartBomRecord',
	...
	createBomRecord: function() {
		...
		AERP.Ajax.request({
			url:'/Satisfactory/createBomRecord',
			jsonData:jsonData,
			success:function(reply) {
	...
	updateBomRecord: function() {
		...
		AERP.Ajax.request({
			url:'/Satisfactory/updateBomRecord',
			jsonData:jsonData,
			success:function(reply) {
				this.fireEvent('bomchanged');
	...
	deleteBomRecord: function() {
		AERP.Ajax.request({
			url:'/Satisfactory/deleteBomRecord',
			jsonData:{bomId: this.bomId},
			success:function(reply) {
				this.fireEvent('bomchanged');
				this.docFormReset();
