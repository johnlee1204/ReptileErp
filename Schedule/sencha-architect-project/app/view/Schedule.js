...
Ext.define('Schedule.view.Schedule', {
	...
	onCalendarmonthBeforeEventadd: function(base, context, eOpts) {
		...
		context.event.data.isScheduleAdmin = this.isScheduleAdmin;
		context.event.data.employeeId = this.employeeId;
	...
	onCalendarmonthEventdrop: function(calendarweeksview, context, eOpts) {
		let calendarStore = this.queryById('calendar').getStore();
		...
		AERP.Ajax.request({
			...
			jsonData:{
				...
				private:context.event.data.private ? 1:0
			},
	...
	onPanelAfterRender: function(component, eOpts) {
		...
		AERP.Ajax.request({
			...
			success:function(reply) {
				...
				this.employeeId = reply.employeeId;
				this.isScheduleAdmin = reply.isScheduleAdmin;
			},
			scope:this,
			mask:this
		});
